    ...
    with torch.no_grad():
        for step, batch in enumerate(data_loader):
            ...
            if should_print and print_count < 2:
                ...
                print(f"eval loss: {eval_loss:.5f} | blue score: {bleu_score} | sari score: {sari_score}")
                print("-" * 100)
...
def train(**kwargs):
    ...
    train_model(start_epoch, eval_loss,
...
def train_model(start_epoch, eval_loss, loaders, optimizer, check_pt_path, best_model_path):
    ...
    for epoch in range(start_epoch, N_EPOCH):
        ...
        for step, batch in enumerate(batches):
            print(f"\r Training step {step} ", end="\r")
        ...
        epoch_eval_loss, bleu_score, sari_score = evaluate(valid_dl, epoch_eval_loss, False)
